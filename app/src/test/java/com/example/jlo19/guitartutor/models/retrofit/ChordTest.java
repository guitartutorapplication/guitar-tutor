...
public class ChordTest {
    ...
    public void getDiagramFilename_ReturnsDiagramFilename() {
        ...
        Chord chord = new Chord(1, "A", "MAJOR", expected, "A.mp4");
    ...
    public void getId_ReturnsId() {
        // arrange
        int expected = 1;
        Chord chord = new Chord(expected, "A", "MAJOR", "A.png", "A.mp4");
    ...
    public void majorChord_ToString_ReturnsName() {
        // arrange
        Chord chord = new Chord(1, "A", "MAJOR", "A.png", "A.mp4");
    ...
    public void minorChord_ToString_ReturnsNameWithm() {
        // arrange
        Chord chord = new Chord(1, "A", "MINOR", "Am.png", "Am.mp4");
    ...
    public void sevenChord_ToString_ReturnsNameWith7() {
        // arrange
        Chord chord = new Chord(1, "A", "SEVEN", "A7.png", "A7.mp4");
    ...
    public void sharpChord_ToString_ReturnsNameWithSharpSymbol() {
        // arrange
        Chord chord = new Chord(1, "A", "SHARP", "A sharp.png", "A sharp.mp4");
    ...
    public void sharpMinorChord_ToString_ReturnsNameWithSharpSymbolAndM() {
        // arrange
        Chord chord = new Chord(1, "A", "SHARP_MINOR", "A sharp m.png", "A sharp m.mp4");
    ...
    public void flatChord_ToString_ReturnsNameWithFlatSymbol() {
        // arrange
        Chord chord = new Chord(1, "A", "FLAT", "A flat.png", "A flat.mp4");
    ...
    public void unrecognisedChord_ToString_ReturnsName() {
        // arrange
        Chord chord = new Chord(1, "A", "MINOR_SEVEN", "Am7.png", "Am7.mp4");
