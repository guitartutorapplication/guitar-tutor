...
public class EditAccountDetailsInteractorTest {
    ...
    @Before
    public void setUp() {
        listener = PowerMockito.mock(EditAccountDetailsListener.class);
    }
    ...
    public void save_OnSuccessfulResponse_CallsSaveSuccessOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is successful
    ...
    public void save_OnInvalidEmailResponse_CallsInvalidEmailOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with invalid email error
    ...
    public void save_OnEmailAlreadyRegisteredResponse_CallsAlreadyRegisteredOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with already registered error
        Response<List<String>> response = FakeResponseCreator.getMessageResponse(false,
    ...
    public void save_OnPasswordTooShortResponse_CallsPasswordTooShortOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with password too short error
        Response<List<String>> response = FakeResponseCreator.getMessageResponse(false,
    ...
    public void save_OnPasswordNoUpperResponse_CallsPasswordNoUpperOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with password no upper error
        Response<List<String>> response = FakeResponseCreator.getMessageResponse(false,
    ...
    public void save_OnPasswordNoLowerResponse_CallsPasswordNoLowerOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with password no lower error
        Response<List<String>> response = FakeResponseCreator.getMessageResponse(false,
    ...
    public void save_OnPasswordNoNumberResponse_CallsPasswordNoNumberOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with password no number error
        Response<List<String>> response = FakeResponseCreator.getMessageResponse(false,
    ...
    public void save_OnErrorResponse_CallsSaveErrorOnListener()
            throws IOException {
        // arrange
        // sets up API with message response that is unsuccessful with general error
        Response<List<String>> response = FakeResponseCreator.getMessageResponse(false,
                "another error");
        DatabaseApi api = new FakeDatabaseApi(new FakeMessageCall(response));
